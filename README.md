...
- **-eps**=float
  ...
  Specify the error threshold such that radeim returns **(1-1/e-eps)**-approximate solution. The default value is 0.1.
...
- **-vanilla**=integer
  ...
  - **0** [default]: the RR set is generated by the radeim method.
...
$ ./radeim -func=format -gname=facebook -pdist=wc
$ ./radeim -func=format -gname=facebook -pdist=wc -wcvariant=1.2

//the uniform setting
$ ./radeim -func=format -gname=facebook -pdist=uniform -pedge=0.01

//the skewed setting with exponential or weibull distribution
$ ./radeim -func=format -gname=facebook -pdist=skewed -skew=exp
$ ./radeim -func=format -gname=facebook -pdist=skewed -skew=weibull
```
...
```shell
//use the radeim method to sample RR sets
$ ./radeim -func=im -gname=facebook -seedsize=100 -eps=0.01

//use the vanilla method to sample RR sets
$ ./radeim -func=im -gname=facebook -seedsize=100 -eps=0.01 -vanilla=1
```
...
$ ./radeim -func=format -gname=facebook -pdist=uniform -pedge=0.5

//influence maximization
$ ./radeim -func=im -gname=facebook -seedsize=100 -eps=0.01 -hist=1
```
